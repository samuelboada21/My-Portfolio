import {Button, Flex, Text, Card, CardBody, Image, Icon, useColorMode, Box } from '@chakra-ui/react'
...
export default function ErrorPage() {
  ...
  return (
    ...
    <Flex justifyContent={"center"} pt={32} h={"100vh"} bg={"blackAlpha.800"}>
      <Card w={["300px","300px", "400px"]} maxH="370px" p={6} boxShadow="md" bg={"blackAlpha.900"} borderRadius={"40px"}>
        <Image
        ...
        <CardBody textAlign={"center"}>
          <Text textColor="white" fontSize="xl" fontWeight="bold" mt={2} textAlign={"center"}>
            <Icon   as={BiError} fontSize={"23px"} mr={"5px"}></Icon>404 Error
          </Text>
          <Button mt={"8px"} as={Link} to="/">Go to Home</Button>
        </CardBody>
      </Card>
    </Flex>
